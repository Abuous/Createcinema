...
public final class DouyinVideoResolver {
    ...
    public static BilibiliResolver.ResolvedMedia resolveAuthenticatedContent(String contentId, NetworkVideoQuality quality)
            throws IOException, InterruptedException {
    ...
    public static String contentId(String input) {
        try {
    ...
    public static String contentUrl(String contentId) {
    ...
    public static boolean isHomepageFeed(String input) {
        try {
    ...
    public static boolean isLongVideo(String input) {
