...
import com.yfy.createcinema.client.video.YoukuVideoResolver;
import com.yfy.createcinema.client.video.TencentVideoResolver;
import com.yfy.createcinema.client.video.IqiyiVideoResolver;
import com.yfy.createcinema.client.film.HlsStreamCache;
import com.yfy.createcinema.client.video.GenericVideoResolver;
...
import com.yfy.createcinema.client.video.CctvVideoResolver;
...
public final class BilibiliResolver {
    ...
    public static ResolvedPlaylist discoverPlaylist(String input) throws IOException, InterruptedException {
        ...
        if (BilibiliBangumiResolver.canResolve(input)) return ResolvedPlaylist.single(input);
    ...
    private static ResolvedMedia resolveUncached(String input, NetworkVideoQuality quality)
        ...
        if (BilibiliBangumiResolver.canResolve(input)) return BilibiliBangumiResolver.resolve(input, quality);
